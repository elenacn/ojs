<?php /* Smarty version 2.6.25-dev, created on 2019-08-18 21:08:52
         compiled from controllers/grid/settings/genre/form/genreForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'controllers/grid/settings/genre/form/genreForm.tpl', 18, false),array('function', 'csrf', 'controllers/grid/settings/genre/form/genreForm.tpl', 19, false),array('function', 'fbvElement', 'controllers/grid/settings/genre/form/genreForm.tpl', 24, false),array('function', 'translate', 'controllers/grid/settings/genre/form/genreForm.tpl', 47, false),array('function', 'fbvFormButtons', 'controllers/grid/settings/genre/form/genreForm.tpl', 48, false),array('block', 'fbvFormArea', 'controllers/grid/settings/genre/form/genreForm.tpl', 22, false),array('block', 'fbvFormSection', 'controllers/grid/settings/genre/form/genreForm.tpl', 23, false),array('modifier', 'escape', 'controllers/grid/settings/genre/form/genreForm.tpl', 39, false),)), $this); ?>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
<?php $this->_tag_stack[] = array('fbvFormSection', array('label' => "manager.setup.genres.key",'description' => "manager.setup.genres.key.description",'for' => 'key')); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<?php echo $this->_plugins['function']['fbvElement'][0][0]->smartyFBVElement(array('type' => 'text','id' => 'key','value' => $this->_tpl_vars['key'],'maxlength' => '30','readonly' => $this->_tpl_vars['keyReadOnly'],'size' => $this->_tpl_vars['fbvStyles']['size']['SMALL']), $this);?>
...
<?php if ($this->_tpl_vars['genreId']): ?>
	<input type="hidden" name="genreId" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['genreId'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" />
<?php endif; ?>
